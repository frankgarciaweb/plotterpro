        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-primary/10 border border-primary/20 mb-4 md:mb-5 lg:mb-6">
              ...
              <span className="text-xs md:text-sm font-medium text-primary">PlotterPro App</span>
            </div>
          ...
          <div className="relative flex justify-center">
            {/* Main phone */}
            <div className="relative z-20 w-64 sm:w-72 md:w-80 lg:w-96">
              <div className="rounded-[2.5rem] bg-card border-4 border-muted overflow-hidden shadow-2xl">
                ...
                <div className="aspect-[9/18] bg-background p-4">
                  {/* Status bar */}
                    ...
                    {[
                      ...
                      <div key={order.id} className="p-3 rounded-xl bg-card border border-border">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className={`text-xs px-2 py-0.5 rounded-full ${order.status === "Enviado" ? "bg-success/20 text-success" : "bg-primary/20 text-primary"
                            }`}>
                            {order.status}
                          </span>
                        </div>
            ...
            <div className="absolute top-4 right-0 sm:top-8 sm:-right-8 z-10 w-40 sm:w-48 md:w-56 lg:w-64 opacity-60 hidden sm:block">
              <div className="rounded-[2.5rem] bg-card border-4 border-muted overflow-hidden shadow-xl rotate-6">
                <div className="aspect-[9/19.5] bg-background p-4">
