...
const BenefitsSection = () => {
  return (
    <section className="py-12 md:py-16 lg:py-24 relative" id="beneficios">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="group relative p-4 md:p-6 lg:p-8 rounded-2xl glass-card hover:border-primary/50 transition-all duration-300 hover:-translate-y-2"
            >
              {/* Icon */}
        ...
        {/* Problems Section */}
        <div className="mt-12 md:mt-16 lg:mt-20 p-4 md:p-6 lg:p-8 rounded-2xl bg-card border border-border">
